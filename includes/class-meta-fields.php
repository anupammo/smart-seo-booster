...
class Smart_SEO_Meta_Fields {
    ...
    public static function enqueue_meta_scripts($hook) {
        ...
        ";
        wp_add_inline_style('smart-seo-meta-fields-inline', $meta_fields_css);
        ...
        jQuery(document).ready(function($) {
            ...
            $('.seo-tab-btn').click(function() {
                ...
                if (tab === 'analysis' && typeof loadSeoAnalysis === 'function') {
                    loadSeoAnalysis();
                }
            });
        });
        ...
        wp_add_inline_script('smart-seo-meta-fields', $tab_script);
    }
