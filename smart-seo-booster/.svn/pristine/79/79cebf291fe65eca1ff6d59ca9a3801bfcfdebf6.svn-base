...
class anupamwp_ssb_Admin_UI {
    ...
    public static function enqueue_assets($hook) {
        ...
        if ($hook === 'smart-seo-booster_page_smart-seo-help') {
            $help_script = "
            jQuery(document).ready(function($) {
                ...
                $('a[href^=\"#\"]').on('click', function(e) {
                    if ($(this).hasClass('nav-tab')) return;
            ...
            ";
            wp_add_inline_script('jquery', $help_script);
        }

        if ($hook === 'smart-seo-booster_page_smart-seo-audit') {
            $audit_script = "
            ...
            ";
            wp_add_inline_script('jquery', $audit_script);
        }
    }
