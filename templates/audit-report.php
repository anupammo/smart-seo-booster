...
<div class="wrap">
    <h1><?php echo esc_html__( 'Smart SEO Audit Report', 'smart-seo-booster-1' ); ?></h1>
    <table class="widefat fixed striped">
        <thead>
            <tr>
                <th><?php esc_html_e( 'Metric', 'smart-seo-booster-1' ); ?></th>
                <th><?php esc_html_e( 'Value', 'smart-seo-booster-1' ); ?></th>
                <th><?php esc_html_e( 'Status', 'smart-seo-booster-1' ); ?></th>
            </tr>
        </thead>
        <tbody>
            <tr>
