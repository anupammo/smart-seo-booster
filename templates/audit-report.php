    ...
    <table class="widefat fixed striped">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo $smart_seo_word_count >= 500 ? esc_html__( 'âœ… Good', 'smart-seo-booster' ) : esc_html__( 'âš ï¸ Consider adding more content', 'smart-seo-booster' ); ?></td>
            </tr>
            <tr>
                <td><?php esc_html_e( 'Headings', 'smart-seo-booster' ); ?></td>
                <td><?php echo absint( $smart_seo_heading_count ); ?></td>
                <td><?php echo $smart_seo_heading_count >= 3 ? esc_html__( 'âœ… Structured', 'smart-seo-booster' ) : esc_html__( 'âš ï¸ Add more headings', 'smart-seo-booster' ); ?></td>
            </tr>
            <tr>
                <td><?php esc_html_e( 'Images', 'smart-seo-booster' ); ?></td>
                <td><?php echo absint( $smart_seo_image_count ); ?></td>
                <td><?php echo $smart_seo_image_count === $smart_seo_alt_count ? esc_html__( 'âœ… All images have alt text', 'smart-seo-booster' ) : esc_html__( 'âš ï¸ Missing alt attributes', 'smart-seo-booster' ); ?></td>
            </tr>
            <tr>
                <td><?php esc_html_e( 'Internal Links', 'smart-seo-booster' ); ?></td>
                <td><?php echo absint( count($smart_seo_link_matches[1] ?? []) ); ?></td>
                <td><?php echo ( count($smart_seo_link_matches[1] ?? []) ) >= 5 ? esc_html__( 'âœ… Good linking', 'smart-seo-booster' ) : esc_html__( 'âš ï¸ Add more internal links', 'smart-seo-booster' ); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo $smart_seo_schema_enabled ? esc_html__( 'âœ… Active', 'smart-seo-booster' ) : esc_html__( 'âš ï¸ Enable in settings', 'smart-seo-booster' ); ?></td>
            </tr>
        </tbody>
    </table>
</div>
